    ...
    private Bean<?> getViewBean(String viewName) {
        ...
        for (Bean<?> bean : all) {
            ...
            if (viewAnnotation == null) {
                ...
                LOG().log(Level.INFO,"View Bean {0} has no CDIView annotation", new Object[] {beanClass.getName()});
            }
    ...
    public View getView(String viewName) {
        ...
        if (viewBean != null) {
            ...
            LOG().log(Level.INFO,
                    ...
                    currentViewCreationalContext);
            View view = (View) beanManager.getReference(viewBean,viewBean.getBeanClass(), currentViewCreationalContext);
